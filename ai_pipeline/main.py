...
from jira_integration import create_jira_bug
from flakiness import update_flakiness, load_history
from report_generator import generate_ai_report, generate_flakiness_report
from notifier import send_email
...
def run():
    ...
    ai_report = generate_ai_report(results, pass_count, fail_count, skip_count)
    flakiness_report = generate_flakiness_report(history)

    # Send both reports
    send_email(ai_report, flakiness_report)
